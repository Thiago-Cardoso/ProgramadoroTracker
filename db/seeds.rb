...
ConfigurationTask.create(user_id: 2, duration: 6, duration_break: 3, duration_break_long: 4, long_pause_delay: 1, have_song: 0, template: 1)
ConfigurationTask.create(user_id: 2, duration: 3, duration_break: 2, duration_break_long: 3, long_pause_delay: 3, have_song: 0, template: 1)
ConfigurationTask.create(user_id: 2, duration: 2, duration_break: 1, duration_break_long: 2, long_pause_delay: 2, have_song: 0, template: 1)
...
ConfigurationTask.create(user_id: 3, duration: 6, duration_break: 3, duration_break_long: 4, long_pause_delay: 1, have_song: 0, template: 1)
ConfigurationTask.create(user_id: 3, duration: 3, duration_break: 2, duration_break_long: 3, long_pause_delay: 3, have_song: 0, template: 1)
ConfigurationTask.create(user_id: 3, duration: 2, duration_break: 1, duration_break_long: 2, long_pause_delay: 2, have_song: 0, template: 1)

ConfigurationTask.create(user_id: 4, duration: 5, duration_break: 2, duration_break_long: 2, long_pause_delay: 2, have_song: 0, template: 1)
...
ConfigurationTask.create(user_id: 4, duration: 3, duration_break: 2, duration_break_long: 3, long_pause_delay: 3, have_song: 0, template: 1)
ConfigurationTask.create(user_id: 4, duration: 2, duration_break: 1, duration_break_long: 2, long_pause_delay: 2, have_song: 0, template: 1)
